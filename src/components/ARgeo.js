  ...
  gpsPosition = () => {
    AFRAME.registerComponent('gps-position', {
      ...
      updatePosition: function () {
        ...
        if (this.crd.accuracy > this.data.accuracy) 
          return;
        
        if (!this.zeroCrd) 
          this.zeroCrd = this.crd;
        
        var p = this
          .el
          .getAttribute('position');

        p.x = this.calcMeters(this.zeroCrd, {
          longitude: this.crd.longitude,
          latitude: this.zeroCrd.latitude
        }) * (this.crd.longitude > this.zeroCrd.longitude
          ? 1
          : -1);
        p.z = this.calcMeters(this.zeroCrd, {
      ...
      calcMeters: function (src, dest) {
        var dlon = THREE
          .Math
          .degToRad(dest.longitude - src.longitude);
        var dlat = THREE
          .Math
          .degToRad(dest.latitude - src.latitude);
  ...
  compassRotation = () => {
    AFRAME.registerComponent('compass-rotation', {
      ...
      init: function () {
        ...
        if (typeof(this.el.components['look-controls']) == 'undefined') 
          return;
        
        this.lookControls = this.el.components['look-controls'];

        this.handlerOrientation = this
          .handlerOrientation
          .bind(this);
      ...
      tick: function (time, timeDelta) {
        ...
        if (this.heading === null || this.lastTimestamp > (time - this.data.fixTime)) 
          return;
      ...
      updateRotation: function () {
        ...
        */
        ...
        var camera_rotation = this
          .el
          .getAttribute('rotation')
          .y;
        var yaw_rotation = THREE
          .Math
          .radToDeg(this.lookControls.yawObject.rotation.y);
  ...
  gpsPlace = () => {
    AFRAME.registerComponent('gps-place', {
      ...
      deferredInit: function () {
        ...
        if (!this.cameraGpsPosition.zeroCrd) 
          return;
      ...
      updatePosition: function () {
        ...
        p.x = this
          .cameraGpsPosition
          .calcMeters(this.cameraGpsPosition.zeroCrd, {
    ...
    return (
      <a-scene embedded artoolkit='sourceType: webcam;'>
        ...
        <a-assets id="assets">
          ...
          <a-asset-item
            id="fence_50_31_0040507_16_asset"
            src="fence_50_31_0040507_16.dae"></a-asset-item>
          <a-asset-item
            id="fence_50_31_0040507_25_asset"
            src="fence_50_31_0040507_25.dae"></a-asset-item>
        ...
        <a-entity id="fences">
          ...
          <a-entity
            id="fence_50_31_0040507_9"
            collada-model="#fence_50_31_0040507_9_asset"
            transparent-texture
            gps-place="longitude: 37.469666813539; latitude: 55.153989996861"></a-entity>
          <a-entity
            id="fence_50_31_0040507_6"
            collada-model="#fence_50_31_0040507_6_asset"
            transparent-texture
            gps-place="longitude: 37.469775988244; latitude: 55.154190366984"></a-entity>
          <a-entity
            id="fence_50_31_0040507_16"
            collada-model="#fence_50_31_0040507_16_asset"
            transparent-texture
            gps-place="longitude: 37.469140087271; latitude: 55.153874109378"></a-entity>
          <a-entity
            id="fence_50_31_0040507_25"
            collada-model="#fence_50_31_0040507_25_asset"
            transparent-texture
            gps-place="longitude: 37.470954400759; latitude: 55.153490379075"></a-entity>
...
function load_hash(d) {
  ...
  for (var i = 0; i < d.objects.length; i++) {
    ...
    if (!document.getElementById(element_id)) {
      var fences = null
      fences.appendChild(ce('a-collada-model', {
        'id': element_id,
